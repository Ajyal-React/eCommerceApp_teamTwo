    ...
    <RightNavContainer>
      ...
      <RightNavList>
        <FlexCol>
          ...
          <Paragraphe fontSize="16px" color="#32353C">
            <RightNavListItems>New arrival</RightNavListItems>
          </Paragraphe>

          <Paragraphe fontSize="16px" color="#32353C">
            <RightNavListItems>Mobiles</RightNavListItems>
          </Paragraphe>

          <Paragraphe fontSize="16px" color="#32353C">
            <RightNavListItems>Laptops</RightNavListItems>
          </Paragraphe>

          <Paragraphe fontSize="16px" color="#32353C">
            <RightNavListItems>HeadPhones</RightNavListItems>
          </Paragraphe>
